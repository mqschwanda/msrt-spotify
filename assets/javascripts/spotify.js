...
// xxxxxxxxxxxxxxxxxxxxxxxx1xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
var userSpotifyId = "ryanseery"; //when done, uncommment the intiailization below
var spotifyAccessToken = "BQBvS35nZl1gWQvgwQmVHsdfm0SEunpnj8vaGoVUASJTGalg7hGIpkQX9HkicWme8lSdTuIO60PCDGfl_GndKaNcNMBdF0dLtQZQ7VdHSmb-aXdHhsByxhfwMWCMtadkVNSJj70DMHSJDZLUXPriNEIJvIPhg79qtNEj-krms22DtNXzx8DsYZeM8XSyQiDYw_JcSxU3Zsg2-sOcIAj2Mc6dYWs71yFeFT9Mp2Amm3Vi5oYkOZh_CoxtYF4RhnmWKTV6-1mrNStZ2LTo";
          ...
          $.ajax({
            ...
            for(var i = 0; i < currentPlaylistResponse.items.length; i++){
              ...
              var newSongObject = {
                ...
                //albumName: currentPlaylistResponse.items[i].track.album[0].name,
              };
